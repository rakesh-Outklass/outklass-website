  ...
  return (
    <div className="min-h-screen  from-background via-primary/5 to-accent/10">
      ...
      <div className="fixed top-16 md:top-20 w-full bg-background/80 backdrop-blur-lg border-b border-border/50 z-40">
        {/* <div className="container-custom py-4 bg-inherit nomar-inncse-cuscon"> */}
        <div className="container-custom py-4 nomar-inncse-cuscon">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-xl font-bold text-accent mb-2">
                AI + INDUSTRIAL IoT ENGINEER Program
              </h1>
              <p className="text-sm text-muted-foreground">
                2.5 Months • Beginner to Advanced • Build 5 Real Projects
              </p>
            </div>
            <div className="flex items-center gap-4">
              <div className="text-right hidden md:block">
                <div className="text-2xl font-bold text-[#ff5f45]">₹19,999</div>
      ...
      <section className="section-padding  md:pt-28">
        <div className="">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="perf_incse inline-flex items-center px-4 py-2 bg-blue-500/10 text-blue-600 rounded-full text-sm font-medium mb-6">
                🌟 Perfect for ECE/EEE Students • 1,800+ Enrolled
              </div>
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Build smart devices with ESP32, sensors, MQTT, and
                cloud,Integrate AI and LLMS. Perfect for electronics students
            ...
            <div className="relative">
              <Card className="overflow-hidden border-card">
                ...
                >
                  <h3 className="text-lg mb-2 text-gen-z-purple">
                    📊 Industry Insights
                  </h3>
                  <p className="text-md text-nowwecrt ">
                    IoT market to reach $1.4 trillion by 2027. 8,500+ IoT jobs
                    in India with 65% growth rate. Perfect for ECE/EEE
                    graduates. Salary range: ₹6-20 LPA.
                  </p>
                </CardContent>
              </Card>
            </div>
      ...
      <section className="section-padding">
        <div className="container-custom">
          <Tabs defaultValue="about" className="w-full">
            <TabsList className="grid w-full grid-cols-4 mb-14 border border-[#00ffff99] h-100">
              <TabsTrigger value="about" className="newtab_hvrbd">
                About
              </TabsTrigger>
              <TabsTrigger value="curriculum" className="newtab_hvrbd">
                Curriculum
              </TabsTrigger>
              <TabsTrigger value="tools" className="newtab_hvrbd">
                Tools & Hardware
              </TabsTrigger>
              {/* <TabsTrigger value="career">Career Paths</TabsTrigger> */}
              <TabsTrigger value="faq" className="newtab_hvrbd">
                FAQs
              </TabsTrigger>
            </TabsList>
            <TabsContent value="about" className="space-y-8">
              <div className="text-center mb-16">
                <h2 className="text-4xl font-bold font-poppins mb-8">
                  🌐{" "}
                  <span className="gradient-text">IoT Developer Program</span>
                </h2>
                <div className="max-w-4xl mx-auto">
                  <Card className="warap_sury bg-gradient-to-r from-blue-500/10 to-purple-500/10 border-2 border-blue-500/30 mb-8">
                    <CardContent className="p-12 text-primary-foreground bg-teal-700 courabt_shrp">
                      <div className="text-2xl font-bold mb-5 flex items-center justify-center text-white">
                        <Zap className="w-8 h-8 mr-3" />
                        You Won't Just Blink LEDs
                      </div>
                      <p className="text-lg leading-relaxed mb-6 text-nowwecrt">
                        You'll build devices that{" "}
                        <span className=" text-accent">
                          talk, sense, decide, and go cloud-native.
                        </span>
                      </p>
                      <div className="text-xl font-bold text-center mb-5 text-white">
                        📝 A Course That Builds You — Not Just Circuits
                      </div>
                      <p className="leading-relaxed text-nowwecrt">
                        We're done with "IoT" that ends at connecting a sensor.
                        Here, you'll build and ship real systems — an ESP32 that
                        posts to the cloud, sensors that send alerts, dashboards
                        that stream live data.
                      </p>
                      <div className="mt-8 p-4 bg-background/10 rounded-sm border border-primary/30">
                        <p className="text-[#ff5f45] font-bold text-center text-white warap_sury_keel">
                          No filler. Just the raw skill set top startups want in
                          IoT engineers.
                        </p>
                      </div>
                    </CardContent>
              ...
              <div className="mb-16">
                <div className="text-center mb-12">
                  <h3 className="text-3xl font-bold font-poppins mb-4 flex items-center justify-center">
                    ...
                    🎯 You Will{" "}
                    <span className="gradient-text ml-2">Actually Do This</span>
                  </h3>
                </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {aboutFeatures.map((feature, index) => (
                    <Card
                      key={index}
                      className="cour_itabt_mel card-hover bg-darkest-grey border-2 border-primary/20 hover:border-primary/50 transition-all duration-300"
                    >
                      <CardContent className="cour_itabt_keel p-6 text-center bg-teal-700 h-full">
                        ...
                        <p className="text-nowwecrt">{feature.description}</p>
                      </CardContent>
                    </Card>
                  ))}
                </div>
              ...
              <div className="mb-12">
                <Card className="sya_notask_mel bg-gradient-to-r from-primary/10 to-accent/10 border-2 border-primary/30">
                  <CardContent className="py-12 px-10 inrn">
                    <div className="text-center mb-10">
                      <h3 className="text-3xl font-bold font-poppins mb-4 flex items-center justify-center text-black">
                      ...
                      <p className="text-lg mb-8  text-muted-foreground">
                        This course breaks the myth that you need embedded
                        experience to break into core tech.
                      </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                      <div className="space-y-6">
                        <div className="flex items-start space-x-4">
                          ...
                          <div>
                            <h4 className="font-bold text-lg mb-2 text-black/80">
                              Complete 5+ IoT Projects
                            </h4>
                            <p className="text-muted-foreground">
                              Portfolio-worthy IoT implementations
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start space-x-4">
                          ...
                          <div>
                            <h4 className="font-bold text-lg mb-2 text-black/80">
                              Get Fluent with Embedded +AI
                            </h4>
                            <p className="text-muted-foreground">
                              Master AI Integration + embedded basics
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-6">
                        <div className="flex items-start space-x-4">
                          ...
                          <div>
                            ...
                            <p className="text-muted-foreground">
                              Confidence backed by real code
                            </p>
                          </div>
                        </div>
                    ...
                    <div className="mt-10 p-6 rounded-lg border border-primary/30 text-center bg-teal-200">
                      <p className="text-lg font-bold text-[#ff5f45] mb-2">
                        In 30 days, you'll transform from circuit-curious to
                        IoT-confident.
                      </p>
                      <p className="text-muted-foreground">
                        This is where hardware meets software meets your career.
                      </p>
                    </div>
                  </CardContent>
                </Card>
            ...
            <TabsContent value="curriculum" className="space-y-6">
              <div className="text-center mb-8">
                <h2 className="text-3xl md:text-4xl font-bold font-poppins mb-4">
                  Phase-Based <span className="gradient-text">Curriculum</span>
                </h2>
                <p className="text-xl text-muted-foreground">
                  Structured into 6 phases from foundations to career outcomes
                </p>
              </div>
              ...
              >
                {phases.map((phase, index) => (
                  ...
                  >
                    <Card className="notshowado_accd hover:shadow-lg transition-shadow duration-300">
                      <CardContent className="p-6">
                        {/* Header */}
                        <div className="flex items-start justify-between mb-4">
                          <div>
                            <h3 className="text-xl font-bold mb-2 accord_keel_clr">
                              {phase.title}
                            </h3>
                            <div className="text-sm text-white accord_keel_clr font-medium">
                              Phase {index + 1}
                            </div>
                          </div>
                          <div className="text-3xl font-bold accord_keel_clr text-muted-foreground/10">
                        ...
                        {/* Accordion Content */}
                        <AccordionContent>
                          <div className="space-y-3 mt-2 text-teal-100">
                            {phase.points.map(
            ...
            <TabsContent value="tools" className="space-y-10">
              <div className="text-center mb-10">
                <h2 className="text-3xl md:text-4xl font-bold font-poppins mb-4">
                  Tools & <span className="gradient-text">Hardware</span>
                </h2>
                <p className="text-xl text-muted-foreground">
                  Plan, develop, simulate, and deploy with this complete IoT
                  stack
                </p>
              </div>
              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                  {generalTools.map((tool, index) => (
                    <Card
                      key={index}
                      className="card-hover text-center hovclr_main_stat"
                    >
                      <CardContent className="p-6">
                        <div className="text-4xl mb-4">{tool.logo}</div>
                        <h3 className="font-bold mb-3 hovclr_down_stat">
                          {tool.name}
                        </h3>
                        <p className="text-sm text-nowwecrt">
                          {tool.description}
                        </p>
                      </CardContent>
                    </Card>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                  {softwareTools.map((tool, index) => (
                    ...
                    >
                      <CardContent className="p-6">
                        <div className="text-4xl mb-4">{tool.logo}</div>
                        <h3 className="font-bold mb-2 hovclr_down_stat">
                          {tool.name}
                        </h3>
            ...
            <TabsContent value="faq" className="space-y-8">
              ...
              <div className="max-w-3xl mx-auto space-y-6">
                {faqs.map((faq, index) => (
                  <Card
                    key={index}
                    className="hover:shadow-lg transition-shadow duration-300 card-hover notshowado_accd"
                  >
                    <CardContent className="px-6 py-8">
                      <h3 className="font-bold mb-4 text-xl accord_keel_clr">
                        {faq.question}
                      </h3>
                      <p className=" text-sm text-nowwecrt leading-relaxed">
                        {faq.answer}
                      </p>
                    </CardContent>
                  </Card>
      ...
      {/* <section className="section-padding bg-muted/30">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold font-poppins mb-4">
              Build <span className="gradient-text">5 Real-World Projects</span>
            </h2>
            <p className="text-xl text-muted-foreground">
              Hands-on projects that prepare you for the IoT industry
            </p>
            ...
            {projects.map((project, index) => (
              ...
              >
                <CardContent className="p-6 pb-0 pl-[2px] pr-0 pt-[2px] border-0 px-[24px] py-[24px] mx-[7px] my-[5px] border-none shadow-none">
                  ...
                  <p className="mb-4 text-teal-200">{project.description}</p>
                  <div className="flex flex-wrap gap-2">
                    {project.technologies.map((tech, techIndex) => (
                      <span
                        key={techIndex}
