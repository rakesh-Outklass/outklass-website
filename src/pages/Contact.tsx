                                        ...
                                        <div className="">
                                            ...
                                            <div>
                                                ...
                                                <select
                                                    ...
                                                    onChange={handleChange}
                                                    className="w-full px-3 py-2 border border-border rounded-md focus:outline-none focus:border-primary hover:border-primary/50 transition-colors duration-300 bg-background mb-10">
                                                    <option value="">
                                                        Select a course
                                                    </option>
                                                    {courses.map(
