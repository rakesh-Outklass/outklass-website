...
import { CheckCircle, Users, Briefcase, TrendingUp, Star, ArrowRight, Award } from "lucide-react";
                                ...
                                <Card className="card-hover text-center relative overflow-hidden h-full">
                                    ...
                                    <CardContent className="p-8 relative z-10">
                                        ...
                                        <div className="space-y-2">
                                            {step.features.map((feature, featureIndex) => <div key={featureIndex} className="flex items-center text-sm text-white/90">
